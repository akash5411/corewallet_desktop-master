...
class TopCoinsPage extends StatefulWidget {
  const TopCoinsPage({Key? key}) : super(key: key);
            ...
            Row(
              children: [
                ...
                const Padding(
                  ...
                  child: Text("Top Coins",style: TextStyle(color: AppColors.White,fontFamily: "Sf-SemiBold",fontSize: 20)),
                ),
            ...
            Center(
                child: Padding(
                  ...
                  child: Container(
                      ...
                      child: Text(
                        "Top coins is add them to your assets. Assets with balances can’t be disabled.",
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(
                                  width:Responsive.isTablet(context)?width*0.13: width*0.16,
                                  child: Text(
