...
class MarketMorePage extends StatefulWidget {
  const MarketMorePage({Key? key}) : super(key: key);

  @override
  State<MarketMorePage> createState() => _MarketMorePageState();
}

class _MarketMorePageState extends State<MarketMorePage> {
  ...
  getTopGainer()async{
    ...
    setState(() {
      bookmarkList = [];
      bookmarkList = List.filled(marketProvider.topGainList.length,false);
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                ...
                const Padding(
                  ...
                  child: Text("Top Geiners",style: TextStyle(color: AppColors.White,fontFamily: "Sf-SemiBold",fontSize: 20)),
                ),
            ...
            Center(
                child: Padding(
                  ...
                  child: Container(
                      ...
                      child: Text(
                        "Top geiners is add them to your assets. Assets with balances can’t be disabled.",
            ...
            SizedBox(
              ...
              child: TextField(
                ...
                onChanged: (value){
                  ...
                  _debouncer.run(() {
                    setState(() {
                      marketProvider.topGainList =  marketProvider.searchTopGainList.where((u) {
                        return (u.name.toLowerCase().contains(value.toLowerCase()));
                      }).toList();
                      marketProvider.topGian == false;
                    });
                  });
                  ...
                  suffixIcon:searchController.text.isEmpty ? const SizedBox() : InkWell(
                    onTap: () {
                      setState(() {
                        ...
                        marketProvider.topGainList = marketProvider.searchTopGainList;
                      });
                    },
                    child: const Padding(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(
                        width: Responsive.isDesktop(context)?width*0.14:width*0.12,
                        child: Text(
                          "24H%",
                          style:TextStyle(
                              color: AppColors.WhiteText,
            ...
            Expanded(
              child: Column(
                children: [
                  !marketProvider.topGian || allCoinLoading
                      ?
                  Helper.dialogCall.showLoader()
                      :
                  Expanded(
                    child: ListView.builder(
                      itemCount: marketProvider.topGainList.length,
                      shrinkWrap: true,
                      itemBuilder: (BuildContext context, int index){
                        var list = marketProvider.topGainList[index];
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              // price and marketCap
                              SizedBox(
                                  width:Responsive.isTablet(context)?width*0.1: width*0.09,
                                  child: Text(
                              ...
                              SizedBox(
                                  width:Responsive.isTablet(context)?width*0.16: width*0.17,
                                  child: Center(
                                    child: Text(
                              ...
                              SizedBox(
                                  width: Responsive.isTablet(context)?width*0.13:width*0.1,
                                  child: Center(
                                    child: Text(
