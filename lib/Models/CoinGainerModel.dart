...
CoinGainerModel coinGainerModelFromJson(String str) => CoinGainerModel.fromJson(json.decode(str));


class CoinGainerModel {
  CoinGainerModel({
  ...
  bool status;
  List<TopGainModel> data;

  factory CoinGainerModel.fromJson(Map<String, dynamic> json) => CoinGainerModel(
    status:json["status"],
    data: List<TopGainModel>.from(json["data"].map((x) => TopGainModel.fromJson(x))),
  );
...
class TopGainModel {
  ...
  factory TopGainModel.fromJson(Map<String, dynamic> json) => TopGainModel(
    id: json["id"],
    name: json["name"],
    symbol: json["symbol"],
    slug: json["slug"],
    ...
    tags: json["tags"] == [] ? [] : List<dynamic>.from(json["tags"].map((x) => x)),
