...
CoinDetailModel coindetailModelFromJson(String str) => CoinDetailModel.fromJson(json.decode(str));
...
class CoinDetailModel {
  ...
  factory CoinDetailModel.fromJson(Map<String, dynamic> json) => CoinDetailModel(
...
class CoinData {
  ...
  factory CoinData.fromJson(Map<String, dynamic> json) => CoinData(
    coinID: CoinID.fromJson(json["${Utils.MarketId}"]),
  );
...
class CoinID {
  ...
  factory CoinID.fromJson(Map<String, dynamic> json) => CoinID(
    id: json["id"],
    name: json["name"],
    symbol: json["symbol"],
    slug: json["slug"],
